        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="mt-8 p-6 bg-gradient-to-br from-primary/5 to-yellow-50 rounded-2xl">
                <h3 className="font-semibold text-gray-900 mb-2">Need Help with Design?</h3>
                <p className="text-gray-600 mb-4">
                  Our design team is available to help you create the perfect custom item. 
