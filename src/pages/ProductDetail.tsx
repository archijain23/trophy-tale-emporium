...
const mockProduct = {
  ...
  reviews: 124,
  category: "Trophies",
  description: "Beautiful golden trophy perfect for recognizing achievements and victories. Made from high-quality materials with a premium finish.",
  features: [
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              <div>
                <span className="text-primary font-medium">{mockProduct.category}</span>
                <h1 className="text-3xl font-bold text-gray-900 mt-2">{mockProduct.name}</h1>
                ...
                <div className="text-3xl font-bold text-primary mt-4">${mockProduct.price}</div>
              </div>
              ...
              <div className="space-y-4 p-6 bg-gray-50 rounded-2xl">
                <h3 className="font-semibold text-gray-900">Customize Your Product</h3>
                ...
                <div>
                  ...
                  <div className="mt-2">
                    ...
                    >
                      ...
                      {customization.uploadedImage ? customization.uploadedImage.name : "Choose Image"}
                    </Button>
                  </div>
                </div>
              </div>
