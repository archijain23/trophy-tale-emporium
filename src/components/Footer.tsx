        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Creating beautiful, customized trophies, mementos, and gifts that celebrate your special moments.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/category/trophies" className="text-gray-300 hover:text-primary transition-colors">
                  Trophies
                </Link>
              </li>
              <li>
                <Link to="/category/photo-frames" className="text-gray-300 hover:text-primary transition-colors">
                  Photo Frames
                </Link>
              </li>
              <li>
                <Link to="/category/key-holders" className="text-gray-300 hover:text-primary transition-colors">
                  Key Holders
                </Link>
              </li>
              <li>
                <Link to="/category/calendars" className="text-gray-300 hover:text-primary transition-colors">
                  Calendars
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start text-gray-300">
                ...
                <span>123 Creative Street<br />Artisan District, NY 10001</span>
              </div>
            </div>
          </div>
        </div>
