...
const steps = [
  {
    ...
    icon: Upload,
    title: "Choose & Upload",
    description: "Browse our products and upload your photos or design ideas. Tell us what you want!"
  },
  {
    id: 2,
    icon: Palette,
    title: "Customize",
    description: "Add text, choose colors, and personalize every detail to make it uniquely yours."
  },
  {
    id: 3,
    icon: CheckCircle,
    title: "We Create",
    description: "Our skilled craftsmen bring your vision to life with premium materials and attention to detail."
  },
  {
    id: 4,
    icon: Truck,
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Creating your perfect custom item is simple! Follow these easy steps and we'll take care of the rest.
          </p>
        </div>
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-primary/10 to-yellow-100 rounded-2xl p-8 max-w-2xl mx-auto">
            ...
            <p className="text-gray-600 mb-6">
              Join hundreds of satisfied customers who've created their perfect custom items with us.
            </p>
